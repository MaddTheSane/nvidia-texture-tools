...
namespace nv
{
    ...
    struct FloatColorCompressor : public CompressorInterface
    {
        ...
        virtual void compressBlock(simd::float4 colors[16], float weights[16], const nvtt::CompressionOptions::Private & compressionOptions, void * output) = 0;
    ...
    {
        virtual void compressBlock(simd::float4 colors[16], float weights[16], const nvtt::CompressionOptions::Private & compressionOptions, void * output);
